...
export class NgxImageSwiperComponent implements DoCheck, AfterViewInit {
    ...
    constructor(private differs: KeyValueDiffers, @Inject(PLATFORM_ID) private platformId: Object) {
    ...
    ngAfterViewInit(): void {
        if (isPlatformBrowser(this.platformId)) {
            ...
            if (this.config.slideShow && this.config.slideShowInterval > 0) {
                setTimeout(() => this.slideShow(), this.config.slideShowInterval * 1000);
            }
        }
    }
    ...
    ====================*/
    setTranslateX() {
        this.imageSwiper.nativeElement.style.transform = `translate3d(${this.currentIndex * -this.imageSwiperWidth}px, 0, 0)`;
    }
