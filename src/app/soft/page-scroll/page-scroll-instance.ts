...
import {EasingLogic, PageScrollConfig, PageScrollTarget, PageScrollViews} from './types';
...
export class PageScrollInstance {
    ...
    public targetScrollPosition: number = 0;
    ...
    public distanceToScroll: number = 0;
    ...
    public executionDuration: number = 0;
    ...
    private interruptListener: EventListenerOrEventListenerObject | undefined;
    ...
    private static getScrollingTargetPosition(pageScrollOptions: PageScrollOptions,
        ...
        if (scrollTargetElement === undefined || scrollTargetElement === null || !scrollTargetElement.getBoundingClientRect) {
    ...
    private static getInlineScrollingTargetPosition(pageScrollOptions: PageScrollOptions, scrollTargetElement: HTMLElement): { top: number, left: number } {
